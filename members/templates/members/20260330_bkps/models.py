...
class Member(models.Model):
    ...
    # CAMBIO: Estandarizado a death_date
    ...
    def get_siblings(self):
        ...
        filters = Q()
        if self.padre: filters |= Q(padre=self.padre)
        if self.madre: filters |= Q(madre=self.madre)
        if not filters: return Member.objects.none()
    ...
    def save(self, *args, **kwargs):
        ...
        # Generamos o actualizamos QR si es nuevo o no tiene
    ...
    def generate_qr(self):
        ...
        # Actualización directa para evitar recursión en save()
